 ...
 * Activity 可以通过调用 bindService() 绑定到服务。在这种情况下，除非所有客户端均取消绑定，
 * 否则 stopService() 或 stopSelf() 不会真正停止服务。因此在这种情况下我们需要特别注意。
 */

public class BinderServiceTest1Activity extends BaseActivity {
    private static final String TAG = "BinderServiceTest1Activ";
    ...
    protected void initViews() {
        setContentView(R.layout.activity_binderservice_test1);
